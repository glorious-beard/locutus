...
>
> **Status:** designed; implementation blocked on [DJ-127](../../docs/DECISION_JOURNAL.md#dj-127) shipping first (DJ-131 reuses DJ-127's write tools, session staging, capability scoping, locking, and ACP spawner). When DJ-127 lands, the phase-fanout collapse described here is the planned next step.
