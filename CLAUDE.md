...
- `docs/DECISION_JOURNAL.md` — 48 architectural decisions with rationale, alternatives considered, and reversals. Consult when a design choice seems ambiguous.
