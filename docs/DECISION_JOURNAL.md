...
**Status:** shipping (Phases 1-4 landed 2026-05-23; Phase 5 empirical validation against winplan re-run pending operator action)
...
**Status:** shipping (Phases 1-6 landed 2026-05-25; empirical validation against Claude Code via claude-agent-acp confirmed in phase 5 ckpt 4 — see plan)
